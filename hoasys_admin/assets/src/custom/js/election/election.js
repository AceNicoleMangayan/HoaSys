...
function show_Votes_Details(id, name) {
	...
	$.ajax({
		...
		success: function (data) {
			...
			$("#voter_count_display").text(data.total_voters);
                            ...
                            <div class="col-12">
                                <div class="m-widget24">
                                    <div class="m-widget24__item">
                                        ...
                                        <span class="m-widget24__stats m--font-success candidate.total_votes">
                                            ${candidate.total_score} Votes
                                        </span>
                                    ...
                                    <div class="col-xl-3 col-md-3 col-sm-12 mt-2 mt-md-0">
                                        <div class="d-flex flex-column flex-md-row">
                                            <button type="button" data-name="${election.election_title}" data-id="${election.id_elect}"
                                                class="btn btn-primary btn-sm btn-icon edit-icon-btn mb-2 mb-md-0 votes_list btn-block">
                                                <span><i class="fa fa-eye"></i> &nbsp;Current Votes</span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
