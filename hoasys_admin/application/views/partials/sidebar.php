<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/src/demo/default/custom/components/custom/toastr/build/toastr.min.css">
    ...
    <div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-light m-aside-menu--submenu-skin-light " data-menu-vertical="true" data-menu-scrollable="true" data-menu-dropdown-timeout="500" style="position: fixed;width: inherit;">
        <ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow" id="side_menu">
            ...
            <?php if (strtolower($role) == 'admin') { ?>
                <li style="" class="m-menu__item <?= (current_url() === base_url('admin')) ? 'm-menu__item--active' : '' ?>">
                ...
                <li id="homeowners_Menu" style="" class="m-menu__item <?= (current_url() === base_url('homeowners')) ? 'm-menu__item--active' : '' ?>">
            ...
            <?php } ?>
            <?php if (strtolower($role) == 'election') { ?>
                <li class="m-menu__item <?= (current_url() === base_url('announcement')) ? 'm-menu__item--active' : '' ?>">
                    <a href="<?= base_url('announcement') ?>" class="m-menu__link">
                        <i class="m-menu__link-icon fa fa-bullhorn"></i>
                        <span class="m-menu__link-text">Announcement</span>
                ...
                <li class="m-menu__item <?= (current_url() === base_url('election')) ? 'm-menu__item--submenu m-menu__item--open m-menu__item--expanded' : '' ?>" aria-haspopup="true">
                    ...
                    <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
                        <ul class="m-menu__subnav">
                            ...
                            <li class="m-menu__item <?= (current_url() === base_url('election/monitor_voters')) ? 'm-menu__item--active' : '' ?>" aria-haspopup="true">
                                <a href="<?= base_url('election/monitor_voters') ?>" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Monitor Voters</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            <?php } ?>
            <?php if (strtolower($role) == 'officer') { ?>
                <li id="homeowners_Menu" style="" class="m-menu__item <?= (current_url() === base_url('homeowners')) ? 'm-menu__item--active' : '' ?>">
                    <a href="<?= base_url('homeowners') ?>" class="m-menu__link">
                        <i class="m-menu__link-icon la la-users "></i>
                        <span class="m-menu__link-text">Homeowners</span>
