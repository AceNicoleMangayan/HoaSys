                                            ...
                                            <div class="m-widget17__stats">
                                                <div class="m-widget17__items m-widget17__items-col1">
                                                    ...
                                                    <div class="m-widget17__item active_click" style=" cursor: pointer;">
                                                        ...
                                                        <span class="m-widget17__subtitle">
                                                            <strong id="active_num">0</strong> Active
                                                        </span>
                                                        <span class="m-widget17__desc">
                                                            Active Homeowners
                                                        </span>
                    ...
                    <div style="margin: 0 20px">
                        <div class="form-group m-form__group row">
                            <div style="margin: 20px auto;">
                                ...
                                <h5 style="text-align: center!important;" class="text-muted" id="announcement_date_dash"></h5>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
...
<script type="text/javascript">
    ...
    function get_count_charts() {
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#active_num").text(data.homeowner[0].homeowner);
    ...
    $(".active_click").on("click", function() {
        window.location.href = "<?= base_url('homeowners'); ?>";
    });
