...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    <div class="m-subheader" style="padding-bottom: 10rem;background-color: #f0f1f7">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title" style="color: #073A4B;"> Voters </h3>
                <input type="hidden">
            </div>
            <br>
        </div>
            ...
            <div class="m-portlet__body">
                <div class="tab-content">
                    <div class="tab-pane active show" id="MinorP" role="tabpanel">
                                ...
                                <div class="col-xl-6 col-sm-12 text-right">
                                    <div class="m-input-icon m-input-icon--left">
                                        <input type="text" autocomplete="off"
                                            ...
                                            placeholder="Search election title, voter name..." id="search_voter">
                        ...
                        <div class="m-section" id="refresh_voters">
                            <div class="m_datatable" id="datatable_voters"></div>
                        </div>
                    </div>
...
<script src="<?php echo base_url() ?>assets/src/custom/js/election/monitor_voters.js?<?php echo $date_time; ?>">
</script>