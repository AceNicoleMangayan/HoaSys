                            ...
                            <div class="row">
                                <div class="col-xl-6 col-sm-12 text-right">
                                    <div class="m-input-icon m-input-icon--left">
                                        <input type="text" autocomplete="off" class="form-control m-input m-input--solid" placeholder="Search Concern Title, Description, Sender..." id="search_Field">
                                ...
                                <div class="col-xl-6 text-left">
                                    <div class="form-group">
                                        <select class="form-control " name="status_concern" id="status_concern" style="width: 100%;">
...
<form id="submit_concern_email" method="post">
    <div class="modal fade" id="concern_send_details" data-id="0" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <div style="margin: 0 20px">
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="form-group">
                                    <label for="recipient-name" class="m--font-bolder">Send To <span class="m--font-danger">*</span></label>
                                    <input type="hidden" id="concern_ID_Update">
                                    <input type="text" class="form-control m-input m-input--solid" id="send_to" autocomplete="off" required disabled>
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="form-group">
                                    <label for="recipient-name" class="m--font-bolder">Subject <span class="m--font-danger">*</span></label>
                                    <input type="text" class="form-control m-input m-input--solid" id="subject_concern" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-xl-12">
                                <div class="form-group">
                                    <label class="m--font-bolder">Email Message to Sender</label>
                                    <textarea class="form-control m-input m-input--solid" style="height: 150px;" id="email_content" rows="3"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
<form id="submit_concern_details" method="post">
    <div class="modal fade" id="concern_details" data-id="0" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" style="max-width: 800px" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <div style="margin: 0 20px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <label class="m--font-bolder">Date Solved/Updated: </label>
                                <span id="concern_date_solved_display">2023-05-7 7:00pm</span>
                            </div>
                            <div class="col-xl-6">
                            ...
                            <div class="col-12">
                                ...
                                <p id="concern_desc_display">. . .</p>
                            </div>
                            <div class="col-12">
                                <label class="m--font-bolder">Email Reply: </label>
                                <p id="concern_reply_disp"> . . .</p>
                            </div>
                            <div class="col-12">
                                <label class="m--font-bolder">Attachments:</label>
                                <div id="display_files_uploaded"></div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" id="solve_btn" class="btn btn-success btn-icon" style="display:none;"><i class="fa fa-check"></i> <span>Mark as solved </span></button>&nbsp;
                    <button type="button" id="unsolve_btn" class="btn btn-danger btn-icon" style="display:none;"><i class="fa fa-remove"></i> <span>Mark as Unsolved </span></button>&nbsp;
                </div>
            </div>
        </div>
    </div>
