...
class General_model extends CI_Model
{
    ...
    public function join_select($query)
    {
		...
		$query = $this->db->query("SELECT status_record AS category, COUNT(id_record) AS value FROM tbl_records WHERE status_record IN ('paid', 'pending') AND year_record = '".$year."' GROUP BY status_record");
